document.addEventListener("DOMContentLoaded", function() {
    const content = [
        ...
        {
  type: "paragraph",
  text: "Platonic Realism: Abstractions are more real than physical objects. It is basically the view that our world is just an abstraction of the world of Forms (à la Plato).<br><br>Realism: Abstractions exist independently.<br><br>Moderate Realism: Abstractions exist dependently, and are the same level of real as their underlying reality.<br><br>Conceptualism: Abstractions only exist in the mind. Entities like temperature may have some kind of existence in the physical world, but they exist primarily as concepts in the mind.<br><br>Nominalism: Abstractions exist, but their level of reality is less than physical objects.<br><br>The concept of śūnyatā (emptiness) in Buddhism: Abstractions and physical objects are illusions. The only existence is the underlying, ultimate reality."
},
