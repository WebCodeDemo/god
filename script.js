document.addEventListener("DOMContentLoaded", function() {
  ...
  type: "paragraphs",
  text: [
    "Platonic Realism: Abstractions are more real than physical objects. It is basically the view that our world is just an abstraction of the world of Forms (à la Plato).",
    "Realism: Abstractions exist independently.",
    "Moderate Realism: Abstractions exist dependently, and are the same level of real as their underlying reality.",
    "Conceptualism: Abstractions only exist in the mind. Entities like temperature may have some kind of existence in the physical world, but they exist primarily as concepts in the mind.",
    "Nominalism: Abstractions exist, but their level of reality is less than physical objects.",
    "Buddhism: Abstractions don't exist, they are all illusions. The only existence is the underlying, ultimate reality."
  ]
},
