document.addEventListener("DOMContentLoaded", function() {
    const content = [
        ...
        { type: "paragraph", text: "Platonic Realism: Abstractions are more real than physical objects. It is basically the view that our world is just an abstraction of the world of Forms (à la Plato)." },
        { type: "paragraph", text: "Realism: Abstractions exist independently." },
        { type: "paragraph", text: "Moderate Realism: Abstractions exist dependently, and are the same level of real as their underlying reality." },
        { type: "paragraph", text: "Conceptualism: Abstractions only exist in the mind. Entities like temperature may have some kind of existence in the physical world, but they exist primarily as concepts in the mind." },
        { type: "paragraph", text: "Nominalism: Abstractions exist, but their level of reality is less than physical objects." },
        { type: "paragraph", text: "Buddhism: Abstractions don't exist, they are all illusions. The only existence is the underlying, ultimate reality." },
